...
const nameVal = params.get('state');
var index = stateCard.findIndex(p => p.stateName == nameVal);
const showLocationInfo = (info) => {
  const container = document.getElementById('container');
  const containerContent = `<div class="container-section">
          <div class="navbar-section">
              <p id="sigin_button"><a href="./signin.html">Sign In</a></p>
              <p>Profile</p>
          ...
          <div class="leftside">
                  <h3>Find a Place to visit in ${info[index].stateName}</h3>
      ...
      <div class="swiper tourist-slider">
              ...
              <div class="swiper-slide slide">
                      <div class="image">
                          <img src="${info[index].touristSpot[0].images}" alt="">
                          </div>
                          <div class="content">
                          <h3>${info[index].touristSpot[0].name}</h3>
                          <div class="button-container">
                              <a href="#" class="btn">Visit</a>
                              <a href="${info[index].touristSpot[0].location}" target="_blank" class="btn">Get location</a>
                              </div>
                      </div>
                  </div>
                  ...
                  <div class="swiper-slide slide">
                      <div class="image">
                      <img src="${info[index].touristSpot[1].images}" alt="">
                      </div>
                      <div class="content">
                          <h3>${info[index].touristSpot[1].name}</h3>
                          <div class="button-container">
                              <a href="#" class="btn">Visit</a>
                              <a href="${info[index].touristSpot[1].location}" target="_blank" class="btn">Get location</a>
                              </div>
                              </div>
                              </div>
                              ...
                              <div class="swiper-slide slide">
                              <div class="image">
                              <img src="${info[index].touristSpot[2].images}" alt="">
                              </div>
                              <div class="content">
                              <h3>${info[index].touristSpot[2].name}</h3>
                          <div class="button-container">
                              <a href="#" class="btn">Visit</a>
                              <a href="${info[index].touristSpot[2].location}" target="_blank" class="btn">Get location</a>
                              </div>
                              </div>
                              </div>
                  ...
                  <div class="swiper-slide slide">
                  <div class="image">
                          <img src="${info[index].touristSpot[3].images}" alt="">
                      </div>
                      <div class="content">
                      <h3>${info[index].touristSpot[3].name}</h3>
                      <div class="button-container">
                      <a href="#" class="btn">Visit</a>
                              <a href="${info[index].touristSpot[3].location}" target="_blank" class="btn">Get location</a>
                              </div>
                      </div>
                  </div>
                  ...
                  <div class="swiper-slide slide">
                  <div class="image">
                  <img src="${info[index].touristSpot[4].images}" alt="">
                  </div>
                  <div class="content">
                  <h3>${info[index].touristSpot[4].name}</h3>
                      <div class="button-container">
                      <a href="#" class="btn">Visit</a>
                      <a href="${info[index].touristSpot[4].location}" target="_blank" class="btn">Get location</a>
                      </div>
                      </div>
              </div>
              ...
              <div class="swiper-slide slide">
                      <div class="image">
                          <img src="${info[index].touristSpot[5].images}" alt="">
                      </div>
                      <div class="content">
                          <h3>${info[index].touristSpot[5].name}</h3>
                          <div class="button-container">
                              <a href="#" class="btn">Visit</a>
                              <a href="${info[index].touristSpot[5].location}" target="_blank" class="btn">Get location</a>
                          </div>
                      </div>
                      </div>
      ...
      <h1 class="heading">Products</h1>
          ...
          <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide slide">
                  <div class="image">
                          <img src="${info[index].products[0].image}" alt="">
                          </div>
                          <div class="content">
                          <h3>${info[index].products[0].name}</h3>
                          <div class="button-container">
                              ...
                              <div class="swiper-slide slide">
                  <div class="image">
                  <img src="${info[index].products[1].image}" alt="">
                  </div>
                  <div class="content">
                      <h3>${info[index].products[1].name}</h3>
                      <div class="button-container">
                      <a href="#" class="btn">Read More</a>
                      </div>
                      </div>
              ...
              <div class="swiper-slide slide">
                  <div class="image">
                  <img src="${info[index].products[2].image}" alt="">
                  </div>
                  <div class="content">
                  <h3>${info[index].products[2].name}</h3>
                  <div class="button-container">
                  <a href="#" class="btn">Read More</a>
                  </div>
                  </div>
              ...
              <div class="swiper-slide slide">
                  <div class="image">
                  <img src="${info[index].products[3].image}" alt="">
                  </div>
                  <div class="content">
                  <h3>${info[index].products[3].name}</h3>
              <div class="button-container">
              <a href="#" class="btn">Read More</a>
              </div>
              </div>
          ...
          <div class="swiper-slide slide">
          <div class="image">
              <img src="${info[index].products[4].image}" alt="">
          </div>
          <div class="content">
              <h3>${info[index].products[4].name}</h3>
              <div class="button-container">
              <a href="#" class="btn">Read More</a>
              </div>
          </div>
          ...
          <div class="swiper-slide slide">
          <div class="image">
      <img src="${info[index].products[5].image}" alt="">
  </div>
  <div class="content">
  <h3>${info[index].products[5].name}</h3>
  <div class="button-container">
          <a href="#" class="btn">Read More</a>
      </div>
  </div>
      ...
      <div class="city" id="city">${info[index].stateName}</div>
      <div class="date" id="date"></div>
      </div>
          <a href='https://www.freepik.com/vectors/education'><img src="images/Weather.jpg" alt=""></a>
