const stateDesc = [
    ...
    {
        stateImage: "https://blog.thomascook.in/wp-content/uploads/2017/09/Untitled-design-20-min.jpg",
        stateName: "Karnataka",
        stateDescription: "Karnataka is primarily known for its Heritage destinations and its Wildlife/ National Parks. Apart from that, it is also famous for its magical hill stations, spectacular waterfalls, pilgrimage centres and a 320km long coastline dotted with un-spoilt beaches.",
...

    {
        ...
        stateName: "Goa",
        stateDescription: "Goa is a state in western India with coastlines stretching along the Arabian Sea.Goa is also known for its beaches, ranging from popular stretches at Baga and Palolem to those in laid-back fishing villages such as Agonda. ",
        stateInfo: "https://en.wikipedia.org/wiki/Goa",
    },
    {
        stateImage: "https://www.india-tours.ca/images/states-images/maharashtra.jpg",
        stateName: "Maharashtra",
        stateDescription: "Maharashtra is one of India's largest commercial and industrial centres, which has led to its being called the gateway of India. Maharashtra is also famous for its culture and beauty. The ancient cave paintings found at Ajanta and Ellora are UNESCO World Heritage sites and popular tourist destinations.",
        stateInfo: "https://en.wikipedia.org/wiki/Maharashtra",
    },
    {
        stateImage: "https://static.toiimg.com/thumb/msid-79626297,width-748,height-499,resizemode=4,imgsize-1120283/.jpg",
        stateName: "Gujarat",
        stateDescription: "Gujarat is famous for its traditional clothing, food and natural landscape. Asiatic lions, Rann of Kutch (White Desert), colourful handicrafts, festival and culture .",
    ...
    {
        stateImage: "https://tfipost.com/wp-content/uploads/2019/09/jammu-kashmir-mice-and-golf-tourism.jpg",
        stateName: "Jammu and Kashmir",
        stateDescription: "Jammu and Kashmir is popularly known as the 'Paradise on Earth' , it is world famous for its scenic splendour, snow-capped mountains, plentiful wildlife, exquisite monuments, hospitable people and local handicrafts.  ",
        stateInfo: "https://en.wikipedia.org/wiki/Jammu_and_Kashmir_(union_territory)",
    },
    {
    ...
    {
        stateImage: "https://2.imimg.com/data2/WA/IM/MY-3387706/uttar-pradesh-tour-500x500.jpg",
        stateName: "Uttar Pradesh",
        stateDescription: "Uttar Pradesh is known for its rich culture and tradition. It is home to Ayodhya and Mathura birthplace of Lord Rama, Lord Krishna and Bhgwan Parshuram respectively. Taj Mahal, one of the New Seven Wonders of the World in Agra is also located in Uttar Pradesh.",
...

    {
        ...
        stateName: "Assam",
        stateDescription: "Assam is a state in northeastern India known for its wildlife, archeological sites and tea plantations. In the west, Guwahati, Assam’s largest city, features silk bazaars and the hilltop Kamakhya Temple. ",
        stateInfo: "https://en.wikipedia.org/wiki/Tourism_in_Assam",
    },

    {
        stateImage: "https://static.toiimg.com/thumb/64977073/View-of-Senapati.jpg?width=1200&height=900",
        stateName: "Manipur",
        stateDescription: "Manipur is a state in Northeast India, with the city of Imphal as its capital. It is bounded by the Indian states of Nagaland to the north, Mizoram to the south and Assam to the west.",
        stateInfo: "https://en.wikipedia.org/wiki/Manipur",
    },
    {
        stateImage: "https://bombaytrooper.com/wp-content/uploads/2019/07/Ujjayanta-palace-agartala-1-1024x681.jpg",
        stateName: "Tripura",
        stateDescription: "Tripura is known for its handicraft, particularly hand-woven cotton fabric, wood carvings, and bamboo products.",
        stateInfo: "https://en.wikipedia.org/wiki/Tripura",
    },

    {
        stateImage: "https://investodisha.gov.in/Application/uploadDocuments/SuccessStory/TO_IW_1551522016.jpg",
        stateName: "Odisha",
        stateDescription: "Odisha (formerly Orissa), an eastern Indian state on the Bay of Bengal, is known for its tribal cultures and its many ancient Hindu temples. The capital, Bhubaneswar, is home to hundreds of temples, notably the intricately-carved Mukteshvara.",
        stateInfo: "https://en.wikipedia.org/wiki/Odisha",
    },
    {
        stateImage: "https://i0.wp.com/www.tusktravel.com/blog/wp-content/uploads/2021/04/Pondicherry-Beach.jpg?fit=800%2C600&ssl=1",
